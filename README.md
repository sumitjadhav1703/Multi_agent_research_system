...
> **Note:** Screenshots are currently unavailable as the application requires active API keys to run. Once configured, the following screenshots should be added to the `assets/` directory.

<!-- Placeholder for Home Page Screenshot -->
![Home Page Placeholder](assets/home_page_placeholder.png)
*The ResearchMind landing page.*

<!-- Placeholder for Running Pipeline Screenshot -->
![Pipeline Running Placeholder](assets/pipeline_running_placeholder.png)
*Real-time progress tracking as agents collaborate.*

<!-- Placeholder for Final Report Screenshot -->
![Final Report Placeholder](assets/final_report_placeholder.png)
*The highly detailed markdown report generated by the Writer Agent.*

<!-- Placeholder for Critic Feedback Screenshot -->
![Critic Feedback Placeholder](assets/critic_feedback_placeholder.png)
*The constructive review and scoring provided by the Critic Agent.*
